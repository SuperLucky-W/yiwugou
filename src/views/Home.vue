      ...
      <div class="banner">
        <div class="modules">
          <div class="nav_list">
            ...
            <a href="#" class="module">
              <img src="../assets/img/banner8.png" alt="">
              <p>品牌馆</p>
            </a>
          </div>
          <div class="nav_list">
            ...
            <a href="#" class="module">
              <img src="../assets/img/banner9.png" alt="">
              <p>产业带</p>
            </a>
          </div>
          <div class="nav_list">
          ...
          <div class="nav_list">
            ...
            <a href="#" class="module">
              <img src="../assets/img/banner12.png" alt="">
              <p>求购与库存</p>
            </a>
          </div>
          <div class="nav_list">
            ...
            <a href="#" class="module">
              <img src="../assets/img/banner13.png" alt="">
              <p>投诉曝光</p>
            </a>
          </div>
          <div class="nav_list">
            ...
            <a href="#" class="module">
              <img src="../assets/img/banner14.png" alt="">
              <p>帮助中心</p>
            </a>
          </div>
        </div>
        ...
        <a href="#" class="wapbanner">
          <img src="../assets/img/wapbanner.jpg" alt="">
        </a>
...
<style scoped>
  ...
  .products .item .info .price{
    ...
    margin: .133333rem 0 .16rem 0;
    box-sizing: border-box;
  }
  .products .item .info .start-number{
    font-size: .32rem;
    color: #999;
    font-weight: 400;
    margin-bottom: .186667rem;
  }
  .products .item .info .shop-name{
    font-size: .32rem;
    color: #666;
  }
  /* loadmore */
